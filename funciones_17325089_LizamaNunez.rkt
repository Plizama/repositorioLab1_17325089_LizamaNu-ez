...
;; Constructor system 
(define (make-system name drives-ingresados users log drive-actual trash fechaCreacion directory)
  (list name drives-ingresados users log drive-actual trash fechaCreacion directory))
...
;; type filesystem = list name X drives-ingresados X users X log X drive_actual X trash X fechaCreacion X directory
...
(define (add-drive system)
    (lambda (letter nameDrive capacity)
      (make-system (get-nameSystem system)(cons (make-letters letter nameDrive capacity "" '())(get-drives-ingresados system))(get-users system)(get-user-log system)(get-drive-actual system)(get-trash system) make-fechaCreacion (get-directory system))))

;; Funcion 4: TDA system -register
(define (add-user system)
  (lambda (userName)
    (make-system (get-nameSystem system)(get-drives-ingresados system)(cons userName (get-users system))(get-user-log system)(get-drive-actual system)(get-trash system) make-fechaCreacion (get-directory system))))
...
(define (login system)
  (lambda (userName-log)
    (cond
      ...
      (make-system (get-nameSystem system)(get-drives-ingresados system)(get-users system) userName-log (get-drive-actual system)(get-trash system) make-fechaCreacion (get-directory system))]
      [else system])))

;; Funcion 6: TDA system logout
(define (logout system)
  ( make-system (get-nameSystem system)(get-drives-ingresados system)(get-users system) "" (get-drive-actual system)(get-trash system) make-fechaCreacion (get-directory system)))

;; Funcion 7: TDA system - switch-drive
(define(switch-drive system)
  (lambda (letter)
    (make-system (get-nameSystem system)(get-drives-ingresados system)(get-users system) (get-user-log system) letter (get-trash system) make-fechaCreacion (get-directory system))))
...
(define (md system)
  (lambda (nameDirectory)
    (make-system (get-nameSystem system)(get-drives-ingresados system)(get-users system) (get-user-log system) (get-drive-actual system)(get-trash system) make-fechaCreacion (cons (make-directory nameDirectory (get-drive-actual system) (get-user-log system) make-fechaCreacion make-fechaCreacion "") (get-directory system)))))